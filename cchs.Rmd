...
The structural pathways are visualized in Figure 2, which illustrates the direct effects of Indigenous status on diabetes and the mediated pathways through healthcare access to mental health outcomes. The diagram confirms the measurement model validity with strong factor loadings and demonstrates the divergent causal pathways between health outcomes.
